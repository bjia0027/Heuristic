...
CFLAGS = -g -O2 -MD -W -Wall -Wimplicit -Wshadow -Wpointer-arith -Wcast-align -Wwrite-strings -Waggregate-return -Wstrict-prototypes -Wmissing-prototypes -Wnested-externs -Wmissing-declarations -Wuninitialized -pthread
WERROR_CFLAGS = -Werror
PYTHON_CFLAGS = -Wp,-U_FORTIFY_SOURCE -Wno-missing-prototypes -Wno-missing-declarations -Wno-write-strings
...
verify-binaries-installcheck:
	...
	@echo "To use installation in ${exec_prefix}/bin, remake with" \
	       "argument 'DISTCC_INSTALLATION=${exec_prefix}/bin'."
